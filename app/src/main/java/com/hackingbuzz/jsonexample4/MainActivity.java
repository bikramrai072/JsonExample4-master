package com.hackingbuzz.jsonexample4;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {    // when we click on a button...do all of this.. set the output to the textView
                ...
                new JsonClass().execute("https://jsonparsingdemo-cec5b.firebaseapp.com/jsonData/moviesDemoList.txt");    //we re creating object n passing URL to AsyncTask first Parameter...then it move to doInBackgroud varagas (String) n then value in varags in 0th location put in url...for use.
    ...
    class JsonClass extends AsyncTask<String, String, String > {     // first param(URL) ..we give Async Task to Process... 2. param for Process...3. the Result we get..(String form)
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                for(int i =0 ; i<parentArray.length(); i++) {
                    ...
                    finalBuffer.append(movieName + " - " + yearName + "\n");

                }

                return finalBuffer.toString();    //it means converting StringBuffer variable to String variable... (using toString())
        ...
        protected void onPostExecute(String s) {
         ...
         //   ArrayAdapter ab= new ArrayAdapter(this,android.R.layout.simple_expandable_list_item_1,s);
           // l1.setAdapter(ab);
            textView.setText(s);
